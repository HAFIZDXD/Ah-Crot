...
def menu():
	os.system('clear')
	jalan("[]SILAHKAN MEMASUKAN USERNAME SC INI\n")
	username = input("[] Username \033[1;91m: \033[1;92m")
	if username =="HAFIZD-XD":
		print("[] BERHASIL MELBU")
		time.sleep(1)
		login()
	else:
		jalan("[] GAGAL MASUK!!!")
		jalan("ANDA AKAN DI ARAHAN KE Whatsapp UNTUK MINTA USERNAME")
...
def log_cookie():
    ...
    banner()
    mkdir_data_login()
    jalan(f"{P}[!] Saran Ektensi CookieDough")
